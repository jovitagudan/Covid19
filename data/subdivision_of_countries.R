...
# iso_internal$Country_Prov[which(iso_internal$Country_Prov %in% "Cabo Verde")] <- "Cape Verde"
# iso_internal$Country_Prov[which(iso_internal$Country_Prov %in% "Congo (Brazzaville)")] <- "Congo"
# iso_internal$Country_Prov[which(iso_internal$Country_Prov %in% "Congo (Kinshasa)")] <- "Democratic Republic of Congo"
# 
